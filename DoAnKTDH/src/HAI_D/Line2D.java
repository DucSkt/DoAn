...
//	private void DDA(Graphics g, int x1, int y1, int x2, int y2) throws InterruptedException {
//		double Dx = x2 - x1;
//		double Dy = y2 - y1;
//		double step;
...
//	}
//
//	private void Bresenham(Graphics g, int x1, int y1, int x2, int y2) throws InterruptedException {
//		int x, y, Dx, Dy;
//		Dx = Math.abs(x2 - x1);
//		Dy = Math.abs(y2 - y1);
//
