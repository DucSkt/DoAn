...
//    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pic/icons8-services-50.png"))); // NOI18N
        jLabel1.setText("2D");

        SutBong.setBackground(new java.awt.Color(255, 153, 153));
        ...
        DoiXungOx.setBackground(new java.awt.Color(255, 153, 153));
        ...
        DoiXungOy.setBackground(new java.awt.Color(255, 153, 153));
        ...
        DoiXungTruc.setBackground(new java.awt.Color(255, 153, 153));
        ...
        XoaManHinh.setBackground(new java.awt.Color(255, 255, 255));
        XoaManHinh.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        XoaManHinh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pic/icons8-restart-50.png"))); // NOI18N
        ...
        PhongLao.setBackground(new java.awt.Color(255, 153, 153));
        ...
        Vat1.setBackground(new java.awt.Color(153, 153, 255));
        Vat1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        Vat1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pic/icons8-contacts-50.png"))); // NOI18N
        ...
        ThuPhong.setBackground(new java.awt.Color(255, 153, 153));
        ...
        jLabel4.setText("Tọa độ bóng X:");
        ...
        Vat2.setBackground(new java.awt.Color(153, 153, 255));
        Vat2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        Vat2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pic/icons8-clock-50.png"))); // NOI18N
        ...
        Quay.setBackground(new java.awt.Color(255, 153, 153));
        Quay.setText("Quay");
        ...
        jLabel15.setText("Giây (s) :");

        jLabel20.setText("Phút (m) :");

        Back.setBackground(new java.awt.Color(255, 255, 255));
        Back.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        Back.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pic/icons8-home-50.png"))); // NOI18N
        ...
        jLabel23.setText("Tọa độ người X:");

        jLabel24.setText("Tọa độ người Y:");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(104, 104, 104)
                        .addComponent(Vat2, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(Quay, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(XoaManHinh, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(87, 87, 87))))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(Vat1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(Vat2, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(XoaManHinh, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
//        }
    ...
    {
        Square2D dongho1= new Square2D(-230+centerWidth,230+ centerHeight, 460, Color.YELLOW);
        dongho1.draw(g2);
        Square2D dongho2= new Square2D(-235+centerWidth,235+ centerHeight, 470, Color.YELLOW);
        dongho2.draw(g2);
        Square2D dongho3= new Square2D(-240+centerWidth,240+ centerHeight, 480, Color.BLACK);
        dongho3.draw(g2);
        Triangle2D tamgiac= new Triangle2D(-225+centerWidth,225+centerHeight,-225+centerWidth,centerHeight,centerWidth,225+centerHeight, Color.BLACK);
        tamgiac.draw(g2);
        Triangle2D tamgiac1= new Triangle2D(-225+centerWidth,-225+centerHeight,-225+centerWidth,centerHeight,centerWidth,-225+centerHeight, Color.BLACK);
        tamgiac1.draw(g2);
        Triangle2D tamgiac2= new Triangle2D(225+centerWidth,-225+centerHeight,225+centerWidth,centerHeight,centerWidth,-225+centerHeight, Color.BLACK);
        tamgiac2.draw(g2);
        Triangle2D tamgiac3= new Triangle2D(225+centerWidth,225+centerHeight,225+centerWidth,centerHeight,centerWidth,225+centerHeight, Color.BLACK);
        tamgiac3.draw(g2);
    }
...
//					line.draw(g2);
    ...
    private void SutBongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SutBongActionPerformed
        ...
        jLabel7.setText((ps.chany2-15)/5+1+"");
         ...
         Thread gx = new Thread(()->{
          for (int i =0;i<listbanh.size();i++) {
            try {
                ...
                toaDo();
                jLabel2.setText((listbanh.get(i).x-jKhungVe.getWidth()/2)/5+1+"");
                Thread.sleep(15);
            } catch (InterruptedException ex) {
                Logger.getLogger(FrmGiaoDien.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void DoiXungOxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DoiXungOxActionPerformed
       ...
       // ps.dau(Integer.parseInt(x1),Integer.parseInt(y1) , 50);
        ...
        ps.chan();
        ps.tay();
        jLabel14.setText((daux)/5+1+"");
        jLabel25.setText((-dauy)/5+1+"");
...
//        listLine.add(lao);
        ...
        Thread gx = new Thread(()->{
          for (int i =0;i<listlao.size();i++) {
            try {
                ...
                jLabel3.setText((listlao.get(i).x1-jKhungVe.getWidth()/2)/5+1+"");               
            } catch (InterruptedException ex) {
                Logger.getLogger(FrmGiaoDien.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void ThuPhongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ThuPhongActionPerformed
       ...
       // ps.dau(Integer.parseInt(x1),Integer.parseInt(y1) , 30);
        ...
        ps.chan();
        ps.tay();
        jLabel14.setText((ps.x1)/5+1+"");
        jLabel25.setText((ps.y1)/5+1+"");
    ...
    private void QuayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_QuayActionPerformed
        ...
        for(int z=0;z<360;z=z+6){
           ...
           if(dem>59){
            ...
            jLabel16.setText((listLine.get(0).x2-centerWidth)/5+1+"");
            jLabel19.setText((listLine.get(0).y2*-1+centerHeight)/5+1+"");
